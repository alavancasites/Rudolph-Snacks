      ...
      <div class="w-box">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            ...
            <dd><a style="margin-top:10px;" target="_blank" class="btn-link" href="<?php echo Yii::app()->request->baseUrl; ?>/uploads/Popup/<?=$model->imagem;?>" ><?=$model->imagem;?></a></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('video'));?></dt>
            <dd><?=Util::formataTexto($model->video)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
              ...
              <dl class="dl-horizontal">
                  ...
                  <dd>
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'update')){
                        ?>
                        <a class="btn" href="<?php echo $this->createUrlRel('update',array('id'=>$model->idpopup));?>"><i class="icon-edit "></i> Editar</a>
                        <?
                    }
                    ?>          
                    <?
