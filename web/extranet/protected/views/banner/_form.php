<div class="form">
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          ...
          <dd>
		  	<?php echo $form->fileField($model, 'imagem', array('class' => 'input-xxlarge')); ?>                  
         <br/><img style="margin-top:10px;" class="img-polaroid" src="<?php echo Yii::app()->request->baseUrl; ?>/<?=$model->Imagem->getAttachment('p');?>" />
		<?
		if(!empty($model->imagem)){
            ?>
            <div style="margin-top:10px;"><label class="checkbox" for="<?=get_class($model)?>_imagem_delete"><?php echo $form->checkbox($model,'imagem_delete'); ?> Excluir imagem</label></div>
            <?
        }?> 
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'imagem_responsiva1',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php $this->widget('application.extensions.Plupload.PluploadWidget', array(
			'model' => $model,
			'attribute' => 'imagem_responsiva1',
		  )); ?>                 
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'imagem_responsiva2',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php $this->widget('application.extensions.Plupload.PluploadWidget', array(
			'model' => $model,
			'attribute' => 'imagem_responsiva2',
		  )); ?>                 
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'botao',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php echo $form->textField($model, 'botao', array('maxlength' => 100,'class' => 'input-xxlarge')); ?>                 
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'externo',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php echo $form->checkBox($model, 'externo'); ?>                 
