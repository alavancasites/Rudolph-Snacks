...
?><div class="row-fluid">
  <div class="span12">
      <div class="w-box">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('imagem_responsiva1'));?></dt>
            <dd><a style="margin-top:10px;" target="_blank" class="btn-link" href="<?php echo Yii::app()->request->baseUrl; ?>/uploads/Banner/<?=$model->imagem_responsiva1;?>" ><?=$model->imagem_responsiva1;?></a></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('imagem_responsiva2'));?></dt>
            <dd><a style="margin-top:10px;" target="_blank" class="btn-link" href="<?php echo Yii::app()->request->baseUrl; ?>/uploads/Banner/<?=$model->imagem_responsiva2;?>" ><?=$model->imagem_responsiva2;?></a></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
