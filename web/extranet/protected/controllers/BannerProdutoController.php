...
class BannerProdutoController extends GxController {

	
    public function getRepresentingFields(){
		return BannerProduto::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'BannerProduto'),
		));
	}

	public function actionCreate() {
		$model = new BannerProduto;
        
		if (isset($_POST['BannerProduto'])) {
			$model->setAttributes($_POST['BannerProduto']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idbanner_produto,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['BannerProduto'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idbanner_produto,'success'=>'update')));
			}
		}
	...
	{
		$model=BannerProduto::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('BannerProduto', array(
            'criteria'=>$criteria,
			'pagination' => array(
