...
class PersonalizadoController extends GxController {

	
    public function getRepresentingFields(){
		return Personalizado::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Personalizado'),
		));
	}

	public function actionCreate() {
		$model = new Personalizado;
        
		if (isset($_POST['Personalizado'])) {
			$model->setAttributes($_POST['Personalizado']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idpersonalizado,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Personalizado'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idpersonalizado,'success'=>'update')));
			}
		}
	...
	{
		$model=Personalizado::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Personalizado', array(
            'criteria'=>$criteria,
			'pagination' => array(
