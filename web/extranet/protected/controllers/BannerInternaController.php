...
class BannerInternaController extends GxController {

	
    public function getRepresentingFields(){
		return BannerInterna::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'BannerInterna'),
		));
	}

	public function actionCreate() {
		$model = new BannerInterna;
        
		if (isset($_POST['BannerInterna'])) {
			$model->setAttributes($_POST['BannerInterna']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idbanner_interna,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['BannerInterna'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idbanner_interna,'success'=>'update')));
			}
		}
	...
	{
		$model=BannerInterna::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'idbanner_interna desc';
        }
		...
		$dataProvider = new CActiveDataProvider('BannerInterna', array(
            'criteria'=>$criteria,
			'pagination' => array(
