...
class PopupController extends GxController {

	
    public function getRepresentingFields(){
		return Popup::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Popup'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['Popup'])) {
			$model->setAttributes($_POST['Popup']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idpopup,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Popup'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idpopup,'success'=>'update')));
			}
		}
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Popup', array(
            'criteria'=>$criteria,
			'pagination' => array(
