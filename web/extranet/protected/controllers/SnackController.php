...
class SnackController extends GxController {

	
    public function getRepresentingFields(){
		return Snack::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Snack'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['Snack'])) {
			$model->setAttributes($_POST['Snack']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idsnack,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Snack'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idsnack,'success'=>'update')));
			}
		}
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Snack', array(
            'criteria'=>$criteria,
			'pagination' => array(
